...
export const modules = [
  {
    id: "pos",
    title: "Core POS Engine",
    description: "Lightning-fast, intuitive point of sale designed for high-volume environments.",
    benefits: ["Offline-first architecture", "Split billing & complex tabs", "Customizable floor plans"],
    workflow: "Orders are punched in under 3 seconds, instantly routed to the kitchen, and synced to cloud reporting.",
  },
  {
    id: "qr",
    title: "QR Ordering & Payments",
    description: "Empower guests to order and pay from their smartphones.",
    benefits: ["Higher ticket sizes", "Faster table turnover", "Zero hardware costs"],
    workflow: "Guest scans QR -> Browse interactive menu -> Orders sent to Kitchen Display System -> Pays via phone.",
  },
  {
    id: "inventory",
    title: "Smart Inventory & Recipes",
    description: "Real-time stock depletion based on recipe configurations.",
    benefits: ["Automated low-stock alerts", "Waste tracking", "Multi-warehouse support"],
    workflow: "Sell an item -> Ingredients auto-deduct -> Reorder alerts triggered when stock hits par level.",
  },
  {
    id: "rooms",
    title: "Hotel Room Management",
    description: "Complete PMS seamlessly connected to your restaurant and bars.",
