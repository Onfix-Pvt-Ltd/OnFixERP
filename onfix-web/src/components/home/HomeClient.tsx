...
import type { HomeContentVM } from "@/lib/cms";
...
// --- MAIN PAGE (client) ---
export function HomeClient({ home }: { home: HomeContentVM }) {
      ...
      <section ref={heroRef} className="relative min-h-[95vh] pt-32 pb-20 flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <motion.div className="lg:col-span-7 flex flex-col items-start" style={{ y: y1, opacity }}>
            ...
            >
              <EnergyButton href={home.hero.primaryCtaHref}>
                {home.hero.primaryCtaLabel} <ArrowRight size={20} className="transition-transform group-hover:translate-x-1" />
              </EnergyButton>
      ...
      <section className="py-40 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <EnergyButton href={home.hero.primaryCtaHref}>
              {home.finalCta.buttonLabel} <ArrowRight size={24} className="transition-transform group-hover:translate-x-2" />
            </EnergyButton>
          </motion.div>
        </div>
      </section>
